...
* `/images`: Contiene el logo institucional.
* `/layers`: Almacena la base de datos geoespacial en formato .js.
* `/styles`: Define la simbología y colores de los resultados.

---
*Desarrollado para el seguimiento al Plan operativo anual -POA- y transparencia municipal.*
¿C
